...
import torch.hub
# from pretrainedfpn_archtitecture import inceptionresnetv2
from fpn_archtitecture.irv import inceptionresnetv2
from torch.nn import Dropout2d, UpsamplingBilinear2d, Sequential
from torch.nn.functional import upsample_bilinear
from torch.utils import model_zoo

from fpn_archtitecture import resnet
from fpn_archtitecture.densenet import densenet121, densenet169, densenet161
from fpn_archtitecture.dpn import dpn92, dpn131, dpn107, dpn92_mc
from fpn_archtitecture.irv import InceptionResNetV2
from fpn_archtitecture.resnet import resnext50_32x4d, resnext101_32x8d
from fpn_archtitecture.senet import se_resnext50_32x4d, se_resnext101_32x4d, senet154, SCSEModule
...
encoder_params = {
    ...
    'seresnext50':
        {'filters': [64, 256, 512, 1024, 2048],
         ...
         'url': 'http://data.lip6.fr/cadene/pretrainedfpn_archtitecture/se_resnext50_32x4d-a260b3a4.pth'},
    'senet154':
        {'filters': [128, 256, 512, 1024, 2048],
         'decoder_filters': [64, 128, 256, 256],
         'init_op': senet154,
         'url': 'http://data.lip6.fr/cadene/pretrainedfpn_archtitecture/senet154-c7b49a05.pth'},
    'seresnext50_fat':
        {'filters': [64, 256, 512, 1024, 2048],
         ...
         'url': 'http://data.lip6.fr/cadene/pretrainedfpn_archtitecture/se_resnext50_32x4d-a260b3a4.pth'},
    # 'seresnext101':
    #     {'filters': [5, 255, 585, 2473, 2721],
    #      'decoder_filters': [64, 128, 256, 256],
    #      'last_upsample': 64,
    #      'init_op': se_resnext101_32x4d,
    #      'url': 'http://data.lip6.fr/cadene/pretrainedfpn_archtitecture/se_resnext101_32x4d-3b2fe3d8.pth'},
    'seresnext101':
        {'filters': [64, 256, 512, 1024, 2048],
         'decoder_filters': [64, 128, 256, 256],
         'last_upsample': 64,
    ...
    'dpn92':
        {'filters': [64, 336, 704, 1552, 2688],
         ...
         'last_upsample': 64,
         'init_op': dpn92,
         'url': 'http://data.lip6.fr/cadene/pretrainedfpn_archtitecture/dpn92_extra-b040e4a9b.pth'},
    'dpn92_mc':
        {'filters': [64, 336, 704, 1552, 2688],
    ...
    'resnext101':
        {'filters': [64, 256, 512, 1024, 2048],
         ...
         'url': 'https://download.pytorch.org/fpn_archtitecture/ig_resnext101_32x8-c38310e5.pth'},
    'resnext50':
        {'filters': [64, 256, 512, 1024, 2048],
         'decoder_filters': [64, 128, 256, 256],
         'last_upsample': 64,
         'init_op': resnext50_32x4d,
         'url': "https://download.pytorch.org/fpn_archtitecture/resnext50_32x4d-7cdf4587.pth"},
    'resnext50_3':
        {'filters': [64, 256, 512, 1024, 2048],
         'decoder_filters': [64, 128, 256, 256],
         'last_upsample': 64,
    ...
    'dpn131':
        {'filters': [128, 352, 832, 1984, 2688],
         ...
         'last_upsample': 64,
         'decoder_filters': [64, 128, 256, 256],
         'url': 'http://data.lip6.fr/cadene/pretrainedfpn_archtitecture/dpn131-71dfe43e0.pth'},
    'dpn107':
        {'filters': [128, 376, 1152, 2432, 2688],
         'init_op': dpn107,
         'last_upsample': 64,
         'decoder_filters': [64, 128, 256, 256],
         'url': 'http://data.lip6.fr/cadene/pretrainedfpn_archtitecture/dpn107_extra-1ac7121e2.pth'},
    'resnet50':
        {'filters': [64, 256, 512, 1024, 2048],
         'decoder_filters': [64, 128, 256, 256],
         'last_upsample': 64,
    ...
    'inceptionresnetv2mc':
        {'filters': [64, 192, 320, 1088, 1536],
         'decoder_filters': [64, 128, 256, 256],
         'last_upsample': 64,
         'url': 'http://data.lip6.fr/cadene/pretrainedfpn_archtitecture/inceptionresnetv2-520b38e4.pth',
