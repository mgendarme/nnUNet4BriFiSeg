...
# ds = load_dataset('/home/gendarme/Documents/nnUNet/nnUNet_preprocessed/Task003_A549/nnUNetData_plans_v2.1_2D_stage0')
# dataload = DataLoader2D(ds, patch_size = (3, 512, 512), final_patch_size = (3, 602, 602), batch_size = 7)
