...
class nnUNetTrainer_fpn2(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(nnUNetTrainer_fpn2, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(nnUNetTrainer_fpn2, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(nnUNetTrainer_fpn2, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
