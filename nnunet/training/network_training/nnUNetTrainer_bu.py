...
class nnUNetTrainer_c(NetworkTrainer):
    ...
    def process_plans(self, plans):
        ...
        ###############################################################################################################
        self.batch_size = 2 #stage_plans['batch_size']  ############ rewrite batch size if necessary ##################
        ###############################################################################################################
...
# dset = load_dataset('/home/gendarme/Documents/nnUNet/nnUNet_preprocessed/Task003_A549/nnUNetData_plans_v2.1_2D_stage0')
# from nnunet.training.network_training.nnUNetTrainerV2 import do_split
# from nnunet.training.dataloading.dataset_loading import DataLoader2D
# daug = DataLoader2D(load_dataset('/home/gendarme/Documents/nnUNet/nnUNet_preprocessed/Task003_A549/nnUNetData_plans_v2.1_stage0'),
#                     patch_size = (3, 602, 602), final_patch_size = (3, 512, 512), batch_size = 4)#,
#                     # False, oversample_foreground_percent=1,
#                     # pad_mode="constant", pad_sides=(1,1), memmap_mode='r')
# daug.data_shape
