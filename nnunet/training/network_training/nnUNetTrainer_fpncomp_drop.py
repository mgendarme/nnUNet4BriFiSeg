...
class nnUNetTrainer_fpncomp_drop(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(nnUNetTrainer_fpncomp_drop, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(nnUNetTrainer_fpncomp_drop, self).run_training()
    ...
    def process_plans(self, plans):
        ...
        ###############################################################################################################
        self.batch_size = stage_plans['batch_size']  ############ rewrite batch size if necessary ##################
        ###############################################################################################################
    ...
    def predict_preprocessed_data_return_seg_and_softmax(self, data: np.ndarray, do_mirroring: bool = True,
        ...
        # valid = list((SeResneXt, nn.DataParallel))
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(nnUNetTrainer_fpncomp_drop, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
