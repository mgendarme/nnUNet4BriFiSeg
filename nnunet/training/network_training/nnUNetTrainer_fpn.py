...
class nnUNetTrainer_fpn(NetworkTrainer):
    ...
    def initialize_network(self):
        ...
        tt = Generic_UNet(1, 32, 1, 2,
                                    ...
                                    False, False, lambda x: x, InitWeights_He(1e-2),
        ...
        # network = SEResNeXtFPNdsb2(seg_classes=1,
        #                                 backbone_arch="seresnext101")
    ...
    def load_plans_file(self):
        ...
        # load_pickle('/home/gendarme/Documents/nnUNet/nnUNet_preprocessed/Task003_A549/nnUNetPlansv2.1_plans_2D.pkl')
    ...
    def process_plans(self, plans):
        ...
        self.batch_size = 4 # stage_plans['batch_size']
