...
class nnUNetTrainer_fpn3(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(nnUNetTrainer_fpn3, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(nnUNetTrainer_fpn3, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(nnUNetTrainer_fpn3, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
